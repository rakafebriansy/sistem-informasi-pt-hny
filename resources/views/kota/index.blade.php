...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold">Kelola Kota</h1>
    ...
    <div class="overflow-x-auto bg-white rounded-lg shadow p-4">
        <table id="kota-table" class="min-w-full text-sm text-left">
            <thead class="bg-gray-100 text-gray-700 uppercase">
                <tr>
                    <th class="px-4 py-3 border-b">No</th>
                    <th class="px-4 py-3 border-b">Nama</th>
                    <th class="px-4 py-3 border-b">Provinsi</th>
    ...
    <div id="modal" class="fixed inset-0 bg-black bg-opacity-50 hidden justify-center items-center z-50">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-semibold text-gray-800">Tambah Kota</h2>
                <button onclick="toggleCreateModal()"
            ...
            <form id="form-tambah">
                @csrf
                <div class="mb-4">
                    <label class="block text-sm text-gray-600 mb-1">Nama Kota</label>
                ...
                <div class="mb-3">
                    ...
                    <select name="provinsi_id" class="w-full border rounded px-2 py-1" required>
    ...
    <div id="modal-edit" class="fixed inset-0 bg-black bg-opacity-50 hidden justify-center items-center z-50">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-semibold text-gray-800">Edit Kota</h2>
            ...
            <form id="form-edit" method="POST">
                ...
                <div class="mb-3">
                    <label class="block text-sm">Provinsi</label>
                    <select name="provinsi_id" id="edit-provinsi" class="w-full border rounded px-2 py-1">
                        @foreach ($provinsiList as $provinsi)
                            <option value="{{ $provinsi->id }}">{{ $provinsi->nama }}</option>
                        @endforeach
                    </select>
        ...
        $('#form-tambah').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    Swal.fire('Berhasil!', 'Kota berhasil ditambahkan.', 'success');
                },
                error: function(xhr) {
                    let msg = 'Gagal menambahkan kota.';
                    if (xhr.status === 422) {
        ...
        $('#form-edit').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function() {
                    toggleEditModal();
                    $('#kota-table').DataTable().ajax.reload();
                    Swal.fire('Berhasil', 'Kota berhasil diperbarui.', 'success');
                },
                error: function() {
